...
export const DEFAULT_MENU_DATA: Category[] = [
  ...
  },
  {
    ...
    items: [
      item('Chaufa con pollo', 'S/ 12.00', undefined, '/chaufa-pollo.webp'), gridItem('Chaufa con chancho', 'S/ 15.00', undefined, '/menu-grid-05-chaufas.png', 'tr'), gridItem('Chaufa con carne', 'S/ 16.00', undefined, '/menu-grid-05-chaufas.png', 'bl'), gridItem('Chaufa con langostino', 'S/ 19.00', undefined, '/menu-grid-05-chaufas.png', 'br'), item('Chaufa especial', 'S/ 20.00', undefined, '/chaufa-especial.webp'), item('Chaufa a lo pobre', 'S/ 16.00', undefined, '/chaufa-pobre.webp'), item('Pollo con verduras', 'S/ 18.00', undefined, '/pollo-verduras.webp'), item('Tipakay + chaufa', 'S/ 19.00', undefined, '/tipakay-chaufa.webp'), item('Limonkay + chaufa', 'S/ 19.00', undefined, '/limonkay-chaufa.webp'),

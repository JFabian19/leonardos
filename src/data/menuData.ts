...
export const DEFAULT_MENU_DATA: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      item('Promo 1/2 pollo', 'S/ 32.00', 'Papas fritas + ensalada + Pepsi Jumbo', '/combo-medio-pepsi.webp'),
      item('Promo 1 pollo entero', 'S/ 58.00', 'Papas fritas + ensalada + Pepsi 1.5 L', '/combo-entero-pepsi.webp'),
      ...
      item('Promo especial 1/2', 'S/ 75.00', '1 pollo entero + 1/2 pollo solo + papas fritas + ensalada', '/promo-especial-medio.webp'),
      item('Promo especial 1/2', 'S/ 66.00', '1 pollo entero + 1/2 pollo solo + papas fritas + ensalada', '/promo-especial-medio.webp'),
  ...
  },
  {
    ...
    items: [
      item('Chaufa con pollo', 'S/ 12.00', undefined, '/chaufa-pollo.webp'), gridItem('Chaufa con chancho', 'S/ 15.00', undefined, '/menu-grid-05-chaufas.png', 'tr'), gridItem('Chaufa con carne', 'S/ 16.00', undefined, '/menu-grid-05-chaufas.png', 'bl'), gridItem('Chaufa con langostino', 'S/ 19.00', undefined, '/menu-grid-05-chaufas.png', 'br'), item('Chaufa especial', 'S/ 20.00', undefined, '/chaufa-especial.webp'), item('Chaufa a lo pobre', 'S/ 16.00', undefined, '/chaufa-pobre.webp'), item('Pollo con verduras + chaufa', 'S/ 18.00', undefined, '/pollo-verduras-chaufa.webp'), item('Tipakay + chaufa', 'S/ 19.00', undefined, '/tipakay-chaufa.webp'), item('Limonkay + chaufa', 'S/ 19.00', undefined, '/limonkay-chaufa.webp'),
  ...
  },
  {
    ...
    items: [
      item('Inca Kola / Coca Cola 3 L', 'S/ 17.00', undefined, '/bebida-inca-3l.webp'), item('Inca Kola / Coca Cola 2.5 L', 'S/ 12.00', undefined, '/bebida-inca-2-5l.webp'), item('Inca Kola / Coca Cola 1.5 L', 'S/ 10.00', undefined, '/bebida-inca-1-5l.webp'), item('Inca Kola / Coca Cola 1 L', 'S/ 8.00', undefined, '/bebida-inca-1l.webp'), item('Gordita', 'S/ 5.00', undefined, '/bebida-gordita.webp'), item('Inca Kola / Coca Cola 600 ml', 'S/ 4.00', undefined, '/bebida-inca-600.webp'), item('Inca Kola / Coca Cola vidrio', 'S/ 3.00', undefined, '/bebida-inca-vidrio.webp'),
